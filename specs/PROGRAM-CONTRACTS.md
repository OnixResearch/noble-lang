...
PO-15, PO-16, and PO-19 through PO-21 govern this profile. All remain open in [verification/obligations.json](verification/obligations.json). [Contract scenarios](conformance/contract-cases.json) are newly authored expectations, not executed evidence.
