...
M5 checks normal and failed string/list conversions against an independent peer. The M3 component probe in [SPEC-BE001](BACKEND-EXPERIMENTS.md) is not that conformance evidence.
