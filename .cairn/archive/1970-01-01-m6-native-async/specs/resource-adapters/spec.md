# M6 bounded native-async resource ownership

This change selects the bounded native task-ownership protocol without weakening the general resource obligations or enabling suspension in `Component-Sync-Bootstrap`. The selected world, native toolchain and driver limits are recorded in [M6 pins](../../../../../verification/m6/pins.json); resource lowering remains subject to [WI-RES-04](../../../../specs/wit-wasi/spec.md#requirement-wi-res-04). Full M6 acceptance is not declared by this delta.
...
## Implementation and assurance scope

The production [task domain](../../../../../crates/noble-kernel/src/async_tasks/domain.rs), [five-state/fifteen-event classifier](../../../../../crates/noble-kernel/src/async_tasks/schema.rs), [reservation bounds](../../../../../crates/noble-kernel/src/async_tasks/bounds.rs), [admission boundary](../../../../../crates/noble-kernel/src/async_tasks/table/admission.rs), [transition](../../../../../crates/noble-kernel/src/async_tasks/transition.rs) and [settlement guards](../../../../../crates/noble-kernel/src/async_tasks/transition/cleanup.rs) implement the local decisions. The peer supplies [retained shell storage](../../../../../verification/m6/peer/src/adapter.rs), [resource transfer](../../../../../verification/m6/peer/src/adapter/resources.rs), [separate authority and receipt integration](../../../../../verification/m6/peer/src/adapter/protection.rs), [driver isolation](../../../../../verification/m6/peer/src/driver.rs), [live-value buffering](../../../../../verification/m6/peer/src/transmit.rs) and [progress probes](../../../../../verification/m6/peer/src/progress.rs).

The local strict [Lean audit](../../../../../proofs/m6/M6Async.lean) has checked 14 required roots: checked-record validation, classifier, pure transition and retained `Table::decide` correspondence, plus ten qualified lifecycle/accounting properties. The [extraction audit](../../../../../verification/m6/extraction.mjs) separately binds all 75 state/event constructor pairs. These claims are distinct from runtime conformance and do not establish callback authenticity, native destruction, engine/ABI correctness or full worker services. The [runtime gate](../../../../../verification/m6/gate.mjs) targets the selected WI-11, WI-12, WI-16 and WORKER-08 workloads and its additional controls; it independently links component values while reusing production Noble task, resource and authority decisions. Full source-bound extraction/refusal and milestone closeout, including independent lock, final regression and Nix gates, remain pending. Broader async, borrowed-export, general-lifetime, Component-Draft/WASI and MW-WORKER obligations are not narrowed by this selection.
