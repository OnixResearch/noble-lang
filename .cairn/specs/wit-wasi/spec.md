...
- GIVEN the `Component-Async-Bootstrap` profile and every field of `input` in [WI-12](../../../specs/conformance/wit-wasi-cases.json)
...
- GIVEN the `Component-Async-Bootstrap` profile and every field of `input` in [WI-11](../../../specs/conformance/wit-wasi-cases.json)
...
- GIVEN the `Component-Async-Bootstrap` profile and every field of `input` in [WI-16](../../../specs/conformance/wit-wasi-cases.json)
