...
#### Scenario: CALC-13 for CALC-SCOPE-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-13](../../../specs/conformance/calculator-cases.json)
- WHEN the `review` procedure for case `CALC-13` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-13`
...
[`CORE-BOOTSTRAP.md`](../core-bootstrap/spec.md) remains the first compiler target. [`PROGRAM-CONTRACTS.md`](../program-contracts/spec.md) governs optional application proofs. This amendment does not require dependent types, implicit coercions, or a new kernel mechanism.


<!-- cairn:scenario-links:start -->
#### Scenario: CALC-05 for CALC-SCOPE-02

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-05](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-05` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-05`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

#### Scenario: CALC-13 for CALC-SCOPE-02
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-01 for CALC-NUM-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-01](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-01` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-01`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

#### Scenario: CALC-08 for CALC-NUM-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-08](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-08` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-08`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-NUM-02
r[CALC-NUM-02]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-04 for CALC-NUM-02

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-04](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-04` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-04`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-NUM-03
r[CALC-NUM-03]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-01 for CALC-NUM-03
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-01 for CALC-NUM-04
...
#### Scenario: CALC-03 for CALC-NUM-04

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-03](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-03` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-03`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-NUM-05
r[CALC-NUM-05]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-01 for CALC-NUM-05
...
#### Scenario: CALC-03 for CALC-NUM-05
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-05 for CALC-NUM-06
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-01 for CALC-PARSE-01
...
#### Scenario: CALC-02 for CALC-PARSE-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-02](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-02` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-02`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-PARSE-02
r[CALC-PARSE-02]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-02 for CALC-PARSE-02
...
#### Scenario: CALC-07 for CALC-PARSE-02

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-07](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-07` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-07`
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-06 for CALC-STATE-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-06](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-06` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-06`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

#### Scenario: CALC-07 for CALC-STATE-01
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-02 for CALC-STATE-02
...
#### Scenario: CALC-03 for CALC-STATE-02
...
#### Scenario: CALC-06 for CALC-STATE-02
...
#### Scenario: CALC-07 for CALC-STATE-02
...
#### Scenario: CALC-08 for CALC-STATE-02
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-06 for CALC-BOUND-01
...
#### Scenario: CALC-13 for CALC-BOUND-01
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-08 for CALC-LIMIT-01
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-08 for CALC-DISPLAY-01
...
#### Scenario: CALC-09 for CALC-DISPLAY-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-09](../../../specs/conformance/calculator-cases.json)
- WHEN the `runtime` procedure for case `CALC-09` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-09`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-APPROX-01
r[CALC-APPROX-01]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-09 for CALC-APPROX-01
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-11 for CALC-AI-01

- GIVEN the `AI-Authoring-Design` profile and every field of `input` in [CALC-11](../../../specs/conformance/calculator-cases.json)
- WHEN the `review` procedure for case `CALC-11` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-11`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-AI-02
r[CALC-AI-02]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-11 for CALC-AI-02
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-11 for CALC-AI-03
...
[`DEVELOPER-EXPERIENCE.md`](../developer-experience/spec.md) owns the underlying diagnostics, local-name, hole, and identity contracts. This benchmark adds no alternative trusted checker. Concrete tool schemas remain an implementation-entry gate.


<!-- cairn:scenario-links:start -->
#### Scenario: CALC-10 for CALC-AI-04
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-12 for CALC-EVIDENCE-01

- GIVEN the `Calculator-Design` profile and every field of `input` in [CALC-12](../../../specs/conformance/calculator-cases.json)
- WHEN the `review` procedure for case `CALC-12` runs against those inputs
- THEN the observations match every field of `expected` in case `CALC-12`

This is a scenario design, not an execution result. The case's `state` and `evidence` fields record its status.

<!-- cairn:scenario-links:end -->

### Requirement: CALC-EVIDENCE-02
r[CALC-EVIDENCE-02]
...
<!-- cairn:scenario-links:start -->
#### Scenario: CALC-12 for CALC-EVIDENCE-02
...
The [calculator scenarios](../../../specs/conformance/calculator-cases.json) are unexecuted harness designs. `Calculator-Design` and `AI-Authoring-Design` label application/test lanes, not Noble language conformance profiles. JSON exact-number fields use decimal strings. They do not define portable Noble serialization.

[Source provenance](../../../specs/SOURCES.md) records the mathematical-computing references and their limits. No calculator, benchmark, or proof execution is claimed by this amendment.


<!-- cairn:scenario-links:start -->
#### Scenario: CALC-13 for CALC-GATE-01
